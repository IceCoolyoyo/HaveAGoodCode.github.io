export class Part {
    static Part1 = Object.freeze(`@Code:q1
        @Ball:true為真，false為假
    ...
    static Part2 = Object.freeze(`@Ball:==用來判斷是否相等
        ...
        @Ball:因為 5 跟 3 不一樣。
        @Answer:false`);
    static Part3 = Object.freeze(`@Ball:System.out.println()
        @Ball:用來輸出結果
        @Ball:就是讓電腦把東西「寫出來」。`);
    static Part4 = Object.freeze(`@Ball:程式寫System.out.println(5 == 5);
        @Ball:這樣電腦會輸出 true
        @Ball:因為 5 跟 5 是一樣的。
    ...
    static Part16 = Object.freeze(`@Ball:整數類型：
    ...
    static Part22 = Object.freeze(`@Ball:byte：能儲存的數字很小，因為現代電腦運算能力很強
    ...
    static Part27 = Object.freeze(`@Ball:或者是減法int a = 0; a = a - 1; System.out.println(a); 
    ...
    static Part29 = Object.freeze(`@Ball:或者是除法：int a = 6; a = a / 3; System.out.println(a); 
    ...
    static Part32 = Object.freeze(`@Ball:比如：假如有個 class 是 Animal（動物）
        @Ball:那它可能是「門」。`);
    static Part33 = Object.freeze(`@Ball:再有個 class 是 Mammal（哺乳類）
        @Ball:它就可以是「綱」。`);
    static Part34 = Object.freeze(` @Ball:最後有個 class Dog（狗）
        @Ball:它就到具體的「屬」或「種」了。`);
    static Part35 = Object.freeze(`@Ball:這樣說，class 就是一種規劃出
        @Ball:「某種東西有什麼特徵」的框架！
        @Ball:但它不會馬上代表一隻具體的狗
