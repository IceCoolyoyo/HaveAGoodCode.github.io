...
(() => {
    ...
    spanIcon.onclick = () => {
        navigator.clipboard.writeText(document.getElementById('code-lines').textContent);
    ...
    var leadingSpacesCount = ((_a = lines[1].match(/^\s*/)) === null || _a === void 0 ? void 0 : _a[0].length) || 0;
